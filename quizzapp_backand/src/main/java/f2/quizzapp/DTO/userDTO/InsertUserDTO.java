...
public record InsertUserDTO(@NotNull(message = "Name is required.")
                            @Size(min = 2, max = 128, message = "The name must be at least 2 characters and 128 characters")
                            String name,
                            @NotNull(message = "Email is required.")
                            @Size(max = 128, message = "The mail must be 128 characters maximum")
                            @Email(message = "The mail field must be filled in and must contain a valid email")
                            String email,
