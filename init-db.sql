...
--
-- Host: db
-- Generation Time: Nov 05, 2025 at 02:30 PM
...
CREATE TABLE `budget_settings` (
  ...
  `settings_date` datetime(6) DEFAULT NULL,
...
CREATE TABLE `location` (
  ...
  `lat` double NOT NULL,
  `lng` double NOT NULL,
  `geometry_id` bigint DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `money_returns` (
  ...
  `expenditure_id` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
ALTER TABLE `budget_settings`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FKmlgmur53til5197x9bca60mx3` (`user_id`);
...
ALTER TABLE `expenditure`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FKg47jb6fa8qxqosxprpxaru45i` (`place_id`),
  ADD KEY `FKruinvaaqgx21ax0sfccr0jxfa` (`category_id`),
  ADD KEY `FKt1mitnbbyr8dlnjubgimj9923` (`user_id`);
...
ALTER TABLE `geometry`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UK_qvhk3skw09jx8rm9d7qufc4n3` (`location_id`),
  ADD UNIQUE KEY `UK_16xy3ardwgd6agwruf3yuhumv` (`place_id`);
...
ALTER TABLE `location`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UK_j5001e4nl6n3s9bsbcsauv77g` (`geometry_id`);

--
-- Indexes for table `money_returns`
--
ALTER TABLE `money_returns`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FKmy63mioce440juyi4dtxlxpgp` (`expenditure_id`);
...
ALTER TABLE `places`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UK_60h82jnnxanni7qw7mjbo2gvh` (`geometry_id`);
...
--
-- Indexes for table `standard_category`
--
...
--
-- AUTO_INCREMENT for table `money_returns`
--
ALTER TABLE `money_returns`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `standard_category`
--
ALTER TABLE `standard_category`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `budget_settings`
--
ALTER TABLE `budget_settings`
  ADD CONSTRAINT `FKmlgmur53til5197x9bca60mx3` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

--
-- Constraints for table `expenditure`
--
ALTER TABLE `expenditure`
  ADD CONSTRAINT `FKg47jb6fa8qxqosxprpxaru45i` FOREIGN KEY (`place_id`) REFERENCES `places` (`id`),
  ADD CONSTRAINT `FKruinvaaqgx21ax0sfccr0jxfa` FOREIGN KEY (`category_id`) REFERENCES `standard_category` (`id`),
  ADD CONSTRAINT `FKt1mitnbbyr8dlnjubgimj9923` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

--
-- Constraints for table `geometry`
--
ALTER TABLE `geometry`
  ADD CONSTRAINT `FK78i1wddf6v1fhrfu3nl355uns` FOREIGN KEY (`location_id`) REFERENCES `location` (`id`),
  ADD CONSTRAINT `FK84te43af9quogp7r0c26k3vk9` FOREIGN KEY (`place_id`) REFERENCES `places` (`id`);

--
-- Constraints for table `location`
--
ALTER TABLE `location`
  ADD CONSTRAINT `FKss3dnvrjn2jd4704ljlpeylfy` FOREIGN KEY (`geometry_id`) REFERENCES `geometry` (`id`);

--
-- Constraints for table `money_returns`
--
ALTER TABLE `money_returns`
  ADD CONSTRAINT `FKmy63mioce440juyi4dtxlxpgp` FOREIGN KEY (`expenditure_id`) REFERENCES `expenditure` (`id`);

--
-- Constraints for table `places`
--
ALTER TABLE `places`
  ADD CONSTRAINT `FK8p48b0r9gd2kwglyb6y6pyolm` FOREIGN KEY (`geometry_id`) REFERENCES `geometry` (`id`);
